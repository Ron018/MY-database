        ...
        <div class="display-section">
            ...
            <div class="main-panel">
                <div class="panel-section feedback">
                    <h1>Public Issues</h1>
                    <p>Stay aware of current issues affecting the community and contribute your thoughts. Working together, we can address challenges and create beneficial solutions for all.</p>
                    <hr>
                    <br>
